        ...
        <div class="container-principal">
            ...
            <div class="d-flex register-f">
                <p class="mt-r">Register for free</p>
                    <a v-if="online" href="./index.html" class="btn-register text-center text-decoration-none d-block">Sign Up</a> 
                    <a v-else href="./register.html" class="btn-register text-center text-decoration-none d-block">Sign Up</a>
            </div>
        </div>
        <!-- Principal -->
        ...
        <footer class="container-total">
            <div class="f-principal">
                <section class="container-pp d-fbd conf-f">
                    ...
                    <p class="mb-0 txt-f">© 2023 Copyright: <a href="./index.html" class="link-f">Bloomrecipes.com</a></p>
                </section>
            </div>
        </footer>
